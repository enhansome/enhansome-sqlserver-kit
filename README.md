...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,202 | 🐛 298 | 📅 2026-08-27
  * SQL injection
...
* Open Source Projects <a id="open-source">
  ...
  * [AzureRMR - R package for interacting with Azure Resource Manager](https://github.com/Azure/AzureRMR) ⭐ 21 | 🐛 4 | 🌐 R | 📅 2025-07-31 (by Microsoft)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,776 | 🐛 427 | 🌐 Go | 📅 2026-08-26 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,202 | 🐛 298 | 📅 2026-08-27 (by Microsoft)
