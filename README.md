...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,217 | 🐛 289 | 🌐 PowerShell | 📅 2026-09-08
  * SQL injection
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 321 | 🌐 Python | 📅 2026-09-09
  ...
  * [SQL Server Ola Hallengren's Maintenance Solution](https://github.com/olahallengren/sql-server-maintenance-solution) ⭐ 3,478 | 🐛 240 | 🌐 TSQL | 📅 2026-08-23 (by Ola Hallengren) (Github)
  ...
  * [sp\_whoisactive](http://whoisactive.com/) (documentation) and github repo for it [sp\_WhoIsActive](https://github.com/amachanic/sp_whoisactive) ⭐ 1,399 | 🐛 20 | 🌐 TSQL | 📅 2026-05-16 (by Adam Machanic)
  ...
  * [Export Prometheus metrics from SQL queries](https://github.com/albertodonato/query-exporter) ⭐ 535 | 🐛 17 | 🌐 Python | 📅 2026-08-29 (by Alberto Donato)
  ...
  * [SQLSetupTools - FixMissingMSI, Product Browser, SQL Registry Viewer](https://github.com/suyouquan/SQLSetupTools) ⭐ 102 | 🐛 7 | 🌐 C# | 📅 2020-03-04 (by Simon Su)
  ...
  * [lowlydba.sqlserver - A cross-platform Ansible collection using PowerShell to configure and maintain SQL Server](https://github.com/lowlydba/lowlydba.sqlserver) ⭐ 26 | 🐛 2 | 🌐 PowerShell | 📅 2026-09-09 - (by John McCall)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,798 | 🐛 410 | 🌐 Go | 📅 2026-09-09 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,217 | 🐛 289 | 🌐 PowerShell | 📅 2026-09-08 (by Microsoft)
  ...
  * [DbUp is a .NET library that helps you to deploy changes to SQL Server databases](https://github.com/DbUp/DbUp) ⭐ 2,625 | 🐛 81 | 🌐 C# | 📅 2026-02-23
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,831 | 🐛 48 | 🌐 PowerShell | 📅 2026-09-03 (by Chrissy LeMaire) (Github)
...
* [Powershell xSQLServer module contains DSC resources for deployment and configuration of SQL Server](https://github.com/PowerShell/xSQLServer) ⭐ 384 | 🐛 295 | 🌐 PowerShell | 📅 2026-09-09 (Github by Microsoft)
