...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,220 | 🐛 286 | 🌐 PowerShell | 📅 2026-09-11
  * SQL injection
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,876 | 🐛 332 | 🌐 Python | 📅 2026-09-13
  ...
  * [Brent Ozar SQL Server First Responder Kit](https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit) ⭐ 3,902 | 🐛 2 | 🌐 TSQL | 📅 2026-09-12 (Github)
  ...
  * [ActiveRecord SQL Server Adapter - SQL Server Adapter For Rails](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 981 | 🐛 24 | 🌐 Ruby | 📅 2026-09-10 (by rails-sqlserver)
  ...
  * [DBA Dash - Performance monitoring tool for SQL Server](https://github.com/trimble-oss/dba-dash) ⭐ 429 | 🐛 86 | 🌐 C# | 📅 2026-09-16 (by Trimble)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,804 | 🐛 421 | 🌐 Go | 📅 2026-09-16 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,220 | 🐛 286 | 🌐 PowerShell | 📅 2026-09-11 (by Microsoft)
