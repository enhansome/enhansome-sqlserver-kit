...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,216 | 🐛 284 | 🌐 PowerShell | 📅 2026-09-10
  * SQL injection
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,868 | 🐛 320 | 🌐 Python | 📅 2026-09-11
  ...
  * [SQL Server Ola Hallengren's Maintenance Solution](https://github.com/olahallengren/sql-server-maintenance-solution) ⭐ 3,480 | 🐛 240 | 🌐 TSQL | 📅 2026-08-23 (by Ola Hallengren) (Github)
  ...
  * [SQL Server in Docker](https://github.com/microsoft/mssql-docker) ⭐ 1,885 | 🐛 525 | 🌐 Dockerfile | 📅 2026-01-27 (by Microsoft)
  ...
  * [DBA Dash - Performance monitoring tool for SQL Server](https://github.com/trimble-oss/dba-dash) ⭐ 428 | 🐛 86 | 🌐 C# | 📅 2026-09-11 (by Trimble)
  ...
  * [lowlydba.sqlserver - A cross-platform Ansible collection using PowerShell to configure and maintain SQL Server](https://github.com/lowlydba/lowlydba.sqlserver) ⭐ 26 | 🐛 2 | 🌐 PowerShell | 📅 2026-09-11 - (by John McCall)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,801 | 🐛 418 | 🌐 Go | 📅 2026-09-11 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,216 | 🐛 284 | 🌐 PowerShell | 📅 2026-09-10 (by Microsoft)
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,832 | 🐛 51 | 🌐 PowerShell | 📅 2026-09-10 (by Chrissy LeMaire) (Github)
