...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,221 | 🐛 286 | 🌐 PowerShell | 📅 2026-09-11
  * SQL injection
...
* Courses <a id="courses"></a>
  * Free
    * [SQL Murder Mystery](https://github.com/NUKnightLab/sql-mysteries) ⭐ 2,217 | 🐛 20 | 🌐 JavaScript | 📅 2025-04-14 (by NUKnightLab)
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,876 | 🐛 329 | 🌐 Python | 📅 2026-09-17
  ...
  * [Brent Ozar SQL Server First Responder Kit](https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit) ⭐ 3,903 | 🐛 2 | 🌐 TSQL | 📅 2026-09-12 (Github)
  ...
  * [SQL Server Ola Hallengren's Maintenance Solution](https://github.com/olahallengren/sql-server-maintenance-solution) ⭐ 3,485 | 🐛 241 | 🌐 TSQL | 📅 2026-09-12 (by Ola Hallengren) (Github)
  ...
  * [ActiveRecord SQL Server Adapter - SQL Server Adapter For Rails](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 980 | 🐛 24 | 🌐 Ruby | 📅 2026-09-10 (by rails-sqlserver)
  ...
  * [DBA Dash - Performance monitoring tool for SQL Server](https://github.com/trimble-oss/dba-dash) ⭐ 429 | 🐛 79 | 🌐 C# | 📅 2026-09-17 (by Trimble)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,807 | 🐛 408 | 🌐 Go | 📅 2026-09-17 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,221 | 🐛 286 | 🌐 PowerShell | 📅 2026-09-11 (by Microsoft)
  ...
  * [DbUp is a .NET library that helps you to deploy changes to SQL Server databases](https://github.com/DbUp/DbUp) ⭐ 2,628 | 🐛 81 | 🌐 C# | 📅 2026-02-23
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,834 | 🐛 34 | 🌐 PowerShell | 📅 2026-09-16 (by Chrissy LeMaire) (Github)
