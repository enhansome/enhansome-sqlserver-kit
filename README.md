...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,216 | 🐛 286 | 🌐 PowerShell | 📅 2026-09-10
  * SQL injection
...
* Courses <a id="courses"></a>
  * Free
    * [SQL Murder Mystery](https://github.com/NUKnightLab/sql-mysteries) ⭐ 2,211 | 🐛 20 | 🌐 JavaScript | 📅 2025-04-14 (by NUKnightLab)
    * [Advanced T-SQL Puzzles](https://github.com/smpetersgithub/AdvancedSQLPuzzles) ⭐ 922 | 🐛 0 | 🌐 TSQL | 📅 2026-09-02 (by Scott Peters)
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 319 | 🌐 Python | 📅 2026-09-10
  ...
  * [SQL Server Ola Hallengren's Maintenance Solution](https://github.com/olahallengren/sql-server-maintenance-solution) ⭐ 3,479 | 🐛 240 | 🌐 TSQL | 📅 2026-08-23 (by Ola Hallengren) (Github)
  ...
  * [sp\_whoisactive](http://whoisactive.com/) (documentation) and github repo for it [sp\_WhoIsActive](https://github.com/amachanic/sp_whoisactive) ⭐ 1,400 | 🐛 20 | 🌐 TSQL | 📅 2026-05-16 (by Adam Machanic)
  ...
  * [DBA Dash - Performance monitoring tool for SQL Server](https://github.com/trimble-oss/dba-dash) ⭐ 428 | 🐛 85 | 🌐 C# | 📅 2026-09-08 (by Trimble)
  ...
  * [language-extensions-sqlserver - SQL Server Language Extensions project](https://github.com/microsoft/sql-server-language-extensions) ⭐ 117 | 🐛 16 | 🌐 C++ | 📅 2026-09-10 (by Microsoft)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,800 | 🐛 413 | 🌐 Go | 📅 2026-09-10 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,216 | 🐛 286 | 🌐 PowerShell | 📅 2026-09-10 (by Microsoft)
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,831 | 🐛 51 | 🌐 PowerShell | 📅 2026-09-10 (by Chrissy LeMaire) (Github)
...
* [Powershell xSQLServer module contains DSC resources for deployment and configuration of SQL Server](https://github.com/PowerShell/xSQLServer) ⭐ 384 | 🐛 295 | 🌐 PowerShell | 📅 2026-09-10 (Github by Microsoft)
