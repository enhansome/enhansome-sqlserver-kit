...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,204 | 🐛 298 | 📅 2026-08-27
  * SQL injection
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,863 | 🐛 343 | 🌐 Python | 📅 2026-08-28
  ...
  * [Brent Ozar SQL Server First Responder Kit](https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit) ⭐ 3,892 | 🐛 12 | 🌐 TSQL | 📅 2026-08-23 (Github)
  ...
  * [Fluent Migrator is a migration framework for .NET much like Ruby on Rails Migrations](https://github.com/fluentmigrator/fluentmigrator) ⭐ 3,509 | 🐛 219 | 🌐 C# | 📅 2026-08-29 (by Eivind Gussiås Løksetheloekset, Mark Junker, Tom Marien)
  * [SQL Server Ola Hallengren's Maintenance Solution](https://github.com/olahallengren/sql-server-maintenance-solution) ⭐ 3,471 | 🐛 239 | 🌐 TSQL | 📅 2026-08-23 (by Ola Hallengren) (Github)
  ...
  * [EFCorePowerTools - Reverse engineering, model visualization and migrations UI for EF Core](https://github.com/ErikEJ/EFCorePowerTools) ⭐ 2,514 | 🐛 4 | 🌐 C# | 📅 2026-08-19 (by Erik Ejlskov Jensen)
  ...
  * [sp\_whoisactive](http://whoisactive.com/) (documentation) and github repo for it [sp\_WhoIsActive](https://github.com/amachanic/sp_whoisactive) ⭐ 1,398 | 🐛 19 | 🌐 TSQL | 📅 2026-05-16 (by Adam Machanic)
  ...
  * [DBA Dash - Performance monitoring tool for SQL Server](https://github.com/trimble-oss/dba-dash) ⭐ 429 | 🐛 85 | 🌐 C# | 📅 2026-08-30 (by Trimble)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,780 | 🐛 428 | 🌐 Go | 📅 2026-08-26 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,204 | 🐛 298 | 📅 2026-08-27 (by Microsoft)
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,828 | 🐛 85 | 🌐 PowerShell | 📅 2026-08-30 (by Chrissy LeMaire) (Github)
...
* [Powershell xSQLServer module contains DSC resources for deployment and configuration of SQL Server](https://github.com/PowerShell/xSQLServer) ⭐ 386 | 🐛 295 | 🌐 PowerShell | 📅 2026-08-30 (Github by Microsoft)
