...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,216 | 🐛 289 | 🌐 PowerShell | 📅 2026-09-03
  * SQL injection
...
* Courses <a id="courses"></a>
  * Free
    * [SQL Murder Mystery](https://github.com/NUKnightLab/sql-mysteries) ⭐ 2,206 | 🐛 20 | 🌐 JavaScript | 📅 2025-04-14 (by NUKnightLab)
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,866 | 🐛 320 | 🌐 Python | 📅 2026-09-08
  ...
  * [Brent Ozar SQL Server First Responder Kit](https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit) ⭐ 3,899 | 🐛 13 | 🌐 TSQL | 📅 2026-08-23 (Github)
  ...
  * [SQL Server Ola Hallengren's Maintenance Solution](https://github.com/olahallengren/sql-server-maintenance-solution) ⭐ 3,477 | 🐛 239 | 🌐 TSQL | 📅 2026-08-23 (by Ola Hallengren) (Github)
  ...
  * [EFCorePowerTools - Reverse engineering, model visualization and migrations UI for EF Core](https://github.com/ErikEJ/EFCorePowerTools) ⭐ 2,515 | 🐛 5 | 🌐 C# | 📅 2026-09-03 (by Erik Ejlskov Jensen)
  ...
  * [ActiveRecord SQL Server Adapter - SQL Server Adapter For Rails](https://github.com/rails-sqlserver/activerecord-sqlserver-adapter) ⭐ 981 | 🐛 23 | 🌐 Ruby | 📅 2026-09-07 (by rails-sqlserver)
  ...
  * [sp\_PressureDetector - stored procedure for quickly detecting CPU and Memory pressure on a SQL Server](https://github.com/erikdarlingdata/DarlingData/tree/main/sp_PressureDetector) ⭐ 723 | 🐛 1 | 🌐 TSQL | 📅 2026-09-04 (by Erik Darling)
  ...
  * [DBA Dash - Performance monitoring tool for SQL Server](https://github.com/trimble-oss/dba-dash) ⭐ 427 | 🐛 85 | 🌐 C# | 📅 2026-09-08 (by Trimble)
  ...
  * [homebrew-mssql-release - brew formulae for Microsoft ODBC Driver for SQL Server and SQL Server Command Line Utilities](https://github.com/microsoft/homebrew-mssql-release) ⭐ 100 | 🐛 5 | 🌐 Ruby | 📅 2026-09-03 (by Microsoft)
  ...
  * [lowlydba.sqlserver - A cross-platform Ansible collection using PowerShell to configure and maintain SQL Server](https://github.com/lowlydba/lowlydba.sqlserver) ⭐ 26 | 🐛 2 | 🌐 PowerShell | 📅 2026-09-08 - (by John McCall)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,797 | 🐛 406 | 🌐 Go | 📅 2026-09-08 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,216 | 🐛 289 | 🌐 PowerShell | 📅 2026-09-03 (by Microsoft)
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,831 | 🐛 47 | 🌐 PowerShell | 📅 2026-09-03 (by Chrissy LeMaire) (Github)
...
* [Powershell xSQLServer module contains DSC resources for deployment and configuration of SQL Server](https://github.com/PowerShell/xSQLServer) ⭐ 384 | 🐛 295 | 🌐 PowerShell | 📅 2026-09-06 (Github by Microsoft)
...
* <https://github.com/benkeen/generatedata> ⭐ 2,283 | 🐛 202 | 🌐 TypeScript | 📅 2026-08-15
