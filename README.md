...
* Security (great thanks to [Troy Hunt](https://www.troyhunt.com/troys-ultimate-list-of-security-links/)) <a id="security"></a>
  * [Microsoft SQL Server Permissions Posters](https://github.com/Microsoft/sql-server-samples/tree/master/samples/features/security/permissions-posters) ⭐ 11,216 | 🐛 284 | 🌐 PowerShell | 📅 2026-09-11
  * SQL injection
...
* Open Source Projects <a id="open-source">
  * [SQLFluff - A SQL linter and auto-formatter for Humans](https://github.com/sqlfluff/sqlfluff) ⭐ 9,872 | 🐛 323 | 🌐 Python | 📅 2026-09-12
  ...
  * [Brent Ozar SQL Server First Responder Kit](https://github.com/BrentOzarULTD/SQL-Server-First-Responder-Kit) ⭐ 3,898 | 🐛 6 | 🌐 TSQL | 📅 2026-09-12 (Github)
...
* Other
  * [Telegraf SQL Server Plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/sqlserver) ⭐ 17,800 | 🐛 418 | 🌐 Go | 📅 2026-09-11 (by influxdata)
  * [SQL Assessment API rules in .csv format](https://github.com/microsoft/sql-server-samples/blob/master/samples/manage/sql-assessment-api/DefaultRuleset.csv) ⭐ 11,216 | 🐛 284 | 🌐 PowerShell | 📅 2026-09-11 (by Microsoft)
...
* [PowerShell dbatools for SQL Server](https://github.com/ctrlbold/dbatools) ⭐ 2,831 | 🐛 50 | 🌐 PowerShell | 📅 2026-09-12 (by Chrissy LeMaire) (Github)
...
* [Powershell xSQLServer module contains DSC resources for deployment and configuration of SQL Server](https://github.com/PowerShell/xSQLServer) ⭐ 384 | 🐛 295 | 🌐 PowerShell | 📅 2026-09-12 (Github by Microsoft)
